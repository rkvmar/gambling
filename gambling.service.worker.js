...
/** @type {string} */
const CACHE_VERSION = '1748133684|5067875685';
/** @type {string} */
const CACHE_PREFIX = 'gambling-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'gambling.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["gambling.html","gambling.js","gambling.offline.html","gambling.icon.png","gambling.apple-touch-icon.png","gambling.worker.js","gambling.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["gambling.wasm","gambling.pck"];
